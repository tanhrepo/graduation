...
CREATE TABLE `busi_article`  (
  ...
  `article_imgurls` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '图片链接',
  `create_user` varchar(20) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '发布用户',
  `create_time` datetime(0) NULL DEFAULT NULL COMMENT '创建时间',
  `update_time` datetime(0) NULL DEFAULT NULL COMMENT '修改时间',
  `article_lable` varchar(20) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '文章标签',
  `article_title` varchar(30) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '文章标题',
  `article_view_count` int(11) NULL DEFAULT NULL COMMENT '访问量',
  `article_comment_count` int(11) NULL DEFAULT NULL COMMENT '点赞数',
  `article_collect_count` int(11) NULL DEFAULT NULL COMMENT '收藏数',
  `article_transmit_count` int(11) NULL DEFAULT NULL COMMENT '转发数',
  `article_trample_count` int(11) NULL DEFAULT NULL COMMENT '踩数',
  `article_vediourls` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '视频链接',
  PRIMARY KEY (`article_id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 2 CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of busi_article
-- ----------------------------
INSERT INTO `busi_article` VALUES (1, 'agnaogn', '/profile/avatar/2021/03/23/cabaf3c7-93a7-4ad2-a683-fde5242c47a8.jpeg', '小明', '2021-04-01 16:04:25', '2021-04-01 16:04:29', '数据库', '测试文章标题', 2930, 302, 5, 15, 15, '/profile/avatar/2021/03/23/cabaf3c7-93a7-4ad2-a683-fde5242c47a8.jpeg');

-- ----------------------------
-- Table structure for busi_comment
-- ----------------------------
DROP TABLE IF EXISTS `busi_comment`;
CREATE TABLE `busi_comment`  (
  `id` int(11) NOT NULL,
  `parent_id` int(11) NULL DEFAULT NULL COMMENT '上级评论',
  `article_id` int(11) NULL DEFAULT NULL COMMENT '评论文章',
...
-- ----------------------------
-- Records of busi_comment
-- ----------------------------

-- ----------------------------
-- Table structure for busi_follows
-- ----------------------------
DROP TABLE IF EXISTS `busi_follows`;
CREATE TABLE `busi_follows`  (
...
-- ----------------------------
-- Records of busi_follows
-- ----------------------------

-- ----------------------------
-- Table structure for busi_image
-- ----------------------------
DROP TABLE IF EXISTS `busi_image`;
CREATE TABLE `busi_image`  (
  `id` int(11) NOT NULL,
  `img_src` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '地址',
  `img_description` varchar(30) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '图片描述',
  `create_time` datetime(0) NULL DEFAULT NULL COMMENT '创建时间',
  `update_time` datetime(0) NULL DEFAULT NULL COMMENT '修改时间',
  `create_by` int(20) NULL DEFAULT NULL COMMENT '上传用户',
  `img_name` varchar(40) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '图片名称',
  `common_id` int(11) NULL DEFAULT NULL COMMENT '对应id（与 img_type对应）',
  `img_type` int(4) NULL DEFAULT NULL COMMENT '图片出现板块（1文章，2评论，3留言，4其他）',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of busi_image
-- ----------------------------

-- ----------------------------
-- Table structure for busi_lable
-- ----------------------------
DROP TABLE IF EXISTS `busi_lable`;
CREATE TABLE `busi_lable`  (
  `lable_id` int(11) NOT NULL AUTO_INCREMENT,
  `lable_name` varchar(40) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `create_by` varchar(20) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `create_time` datetime(0) NULL DEFAULT NULL,
  `del_flag` int(10) NULL DEFAULT NULL,
  `lable_description` varchar(30) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '标签描述',
  PRIMARY KEY (`lable_id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of busi_lable
-- ----------------------------

-- ----------------------------
-- Table structure for busi_operation
-- ----------------------------
DROP TABLE IF EXISTS `busi_operation`;
CREATE TABLE `busi_operation`  (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `article_id` int(11) NULL DEFAULT NULL,
  `operation_user` varchar(20) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `operation_type` int(10) NULL DEFAULT NULL,
  `comment` blob NULL COMMENT '评论内容',
  `operation_time` datetime(0) NULL DEFAULT NULL COMMENT '操作时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of busi_operation
-- ----------------------------

-- ----------------------------
-- Table structure for busi_user_sigature
-- ----------------------------
DROP TABLE IF EXISTS `busi_user_sigature`;
CREATE TABLE `busi_user_sigature`  (
  `id` int(11) NOT NULL,
  `user_id` int(11) NULL DEFAULT NULL,
...
-- ----------------------------
-- Records of busi_user_sigature
-- ----------------------------

-- ----------------------------
-- Table structure for busi_vedio
-- ----------------------------
DROP TABLE IF EXISTS `busi_vedio`;
CREATE TABLE `busi_vedio`  (
  `id` int(11) NOT NULL,
  `vedio_src` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '地址',
  `vedio_decrioption` varchar(30) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '描述',
  `create_time` datetime(0) NULL DEFAULT NULL COMMENT '创建时间',
  `update_time` datetime(0) NULL DEFAULT NULL COMMENT '修改时间',
  `create_by` int(20) NULL DEFAULT NULL COMMENT '上传用户',
  `vedio_name` varchar(40) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '视频名称',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of busi_vedio
-- ----------------------------
...
-- ----------------------------
INSERT INTO `gen_table` VALUES (4, 'busi_article', '', NULL, NULL, 'BusiArticle', 'crud', 'com.ruoyi.system', 'system', 'article', NULL, 'dfm', '0', '/', NULL, 'admin', '2021-04-01 16:16:43', '', NULL, NULL);
...
-- ----------------------------
INSERT INTO `gen_table_column` VALUES (38, '4', 'article_id', NULL, 'int(255)', 'Long', 'articleId', '1', '1', NULL, '1', NULL, NULL, NULL, 'EQ', 'input', '', 1, 'admin', '2021-04-01 16:16:43', '', NULL);
INSERT INTO `gen_table_column` VALUES (39, '4', 'article_content', '文章内容', 'longtext', 'String', 'articleContent', '0', '0', NULL, '1', '1', '1', '1', 'EQ', 'editor', '', 2, 'admin', '2021-04-01 16:16:43', '', NULL);
INSERT INTO `gen_table_column` VALUES (40, '4', 'article_imgurls', '图片链接', 'varchar(255)', 'String', 'articleImgurls', '0', '0', NULL, '1', '1', '1', '1', 'EQ', 'input', '', 3, 'admin', '2021-04-01 16:16:43', '', NULL);
INSERT INTO `gen_table_column` VALUES (41, '4', 'create_user', '发布用户', 'varchar(20)', 'String', 'createUser', '0', '0', NULL, '1', '1', '1', '1', 'EQ', 'input', '', 4, 'admin', '2021-04-01 16:16:43', '', NULL);
INSERT INTO `gen_table_column` VALUES (42, '4', 'create_time', '创建时间', 'datetime', 'Date', 'createTime', '0', '0', NULL, '1', NULL, NULL, NULL, 'EQ', 'datetime', '', 5, 'admin', '2021-04-01 16:16:43', '', NULL);
INSERT INTO `gen_table_column` VALUES (43, '4', 'update_time', '修改时间', 'datetime', 'Date', 'updateTime', '0', '0', NULL, '1', '1', NULL, NULL, 'EQ', 'datetime', '', 6, 'admin', '2021-04-01 16:16:43', '', NULL);
INSERT INTO `gen_table_column` VALUES (44, '4', 'article_lable', '文章标签', 'varchar(20)', 'String', 'articleLable', '0', '0', NULL, '1', '1', '1', '1', 'EQ', 'input', '', 7, 'admin', '2021-04-01 16:16:43', '', NULL);
INSERT INTO `gen_table_column` VALUES (45, '4', 'article_title', '文章标题', 'varchar(30)', 'String', 'articleTitle', '0', '0', NULL, '1', '1', '1', '1', 'EQ', 'input', '', 8, 'admin', '2021-04-01 16:16:43', '', NULL);
INSERT INTO `gen_table_column` VALUES (46, '4', 'article_view_count', '访问量', 'int(11)', 'Long', 'articleViewCount', '0', '0', NULL, '1', '1', '1', '1', 'EQ', 'input', '', 9, 'admin', '2021-04-01 16:16:43', '', NULL);
INSERT INTO `gen_table_column` VALUES (47, '4', 'article_comment_count', '点赞数', 'int(11)', 'Long', 'articleCommentCount', '0', '0', NULL, '1', '1', '1', '1', 'EQ', 'input', '', 10, 'admin', '2021-04-01 16:16:43', '', NULL);
INSERT INTO `gen_table_column` VALUES (48, '4', 'article_collect_count', '收藏数', 'int(11)', 'Long', 'articleCollectCount', '0', '0', NULL, '1', '1', '1', '1', 'EQ', 'input', '', 11, 'admin', '2021-04-01 16:16:43', '', NULL);
INSERT INTO `gen_table_column` VALUES (49, '4', 'article_transmit_count', '转发数', 'int(11)', 'Long', 'articleTransmitCount', '0', '0', NULL, '1', '1', '1', '1', 'EQ', 'input', '', 12, 'admin', '2021-04-01 16:16:43', '', NULL);
INSERT INTO `gen_table_column` VALUES (50, '4', 'article_trample_count', '踩数', 'int(11)', 'Long', 'articleTrampleCount', '0', '0', NULL, '1', '1', '1', '1', 'EQ', 'input', '', 13, 'admin', '2021-04-01 16:16:43', '', NULL);
INSERT INTO `gen_table_column` VALUES (51, '4', 'article_vediourls', '视频链接', 'varchar(255)', 'String', 'articleVediourls', '0', '0', NULL, '1', '1', '1', '1', 'EQ', 'input', '', 14, 'admin', '2021-04-01 16:16:43', '', NULL);
...
-- ----------------------------
INSERT INTO `qrtz_scheduler_state` VALUES ('RuoyiScheduler', 'USER-20181009HC1617342309447', 1617356491532, 15000);
...
-- ----------------------------
INSERT INTO `qrtz_triggers` VALUES ('RuoyiScheduler', 'TASK_CLASS_NAME1', 'DEFAULT', 'TASK_CLASS_NAME1', 'DEFAULT', NULL, 1617342310000, -1, 5, 'PAUSED', 'CRON', 1617342309000, 0, NULL, 2, '');
INSERT INTO `qrtz_triggers` VALUES ('RuoyiScheduler', 'TASK_CLASS_NAME2', 'DEFAULT', 'TASK_CLASS_NAME2', 'DEFAULT', NULL, 1617342315000, -1, 5, 'PAUSED', 'CRON', 1617342310000, 0, NULL, 2, '');
INSERT INTO `qrtz_triggers` VALUES ('RuoyiScheduler', 'TASK_CLASS_NAME3', 'DEFAULT', 'TASK_CLASS_NAME3', 'DEFAULT', NULL, 1617342320000, -1, 5, 'PAUSED', 'CRON', 1617342310000, 0, NULL, 2, '');
...
INSERT INTO `sys_dict_data` VALUES (29, 0, '点赞', '1', 'operation_type', NULL, NULL, 'N', '0', 'admin', '2021-03-26 18:52:08', '', NULL, NULL);
INSERT INTO `sys_dict_data` VALUES (30, 0, '踩一踩', '2', 'operation_type', NULL, NULL, 'N', '0', 'admin', '2021-03-26 18:52:21', '', NULL, NULL);
INSERT INTO `sys_dict_data` VALUES (31, 0, '转发', '3', 'operation_type', NULL, NULL, 'N', '0', 'admin', '2021-03-26 18:52:30', '', NULL, NULL);
INSERT INTO `sys_dict_data` VALUES (32, 0, '收藏', '4', 'operation_type', NULL, NULL, 'N', '0', 'admin', '2021-03-26 18:52:39', '', NULL, NULL);
INSERT INTO `sys_dict_data` VALUES (34, 0, '评论', '5', 'operation_type', NULL, NULL, 'N', '0', 'admin', '2021-03-26 18:52:54', '', NULL, NULL);
...
INSERT INTO `sys_dict_type` VALUES (11, '用户操作类型', 'operation_type', '0', 'admin', '2021-03-26 18:51:39', '', NULL, '用户操作类型');
...
-- ----------------------------
INSERT INTO `sys_logininfor` VALUES (100, 'admin', '127.0.0.1', '内网IP', 'Chrome 8', 'Windows 10', '0', '登录成功', '2020-09-27 14:56:08');
INSERT INTO `sys_logininfor` VALUES (101, 'admin', '127.0.0.1', '内网IP', 'Chrome 8', 'Windows 10', '0', '登录成功', '2020-09-27 17:27:16');
INSERT INTO `sys_logininfor` VALUES (102, 'admin', '127.0.0.1', '内网IP', 'Chrome 8', 'Windows 10', '0', '登录成功', '2020-10-09 15:03:46');
INSERT INTO `sys_logininfor` VALUES (103, 'admin', '127.0.0.1', '内网IP', 'Chrome 8', 'Windows 10', '0', '登录成功', '2020-10-10 10:58:13');
INSERT INTO `sys_logininfor` VALUES (104, 'admin', '127.0.0.1', '内网IP', 'Chrome 8', 'Windows 10', '0', '退出成功', '2021-03-23 14:51:30');
INSERT INTO `sys_logininfor` VALUES (105, 'admin', '127.0.0.1', '内网IP', 'Chrome 8', 'Windows 10', '0', '登录成功', '2021-03-23 14:51:49');
INSERT INTO `sys_logininfor` VALUES (106, 'admin', '127.0.0.1', '内网IP', 'Chrome 8', 'Windows 10', '1', '验证码错误', '2021-03-26 18:46:44');
INSERT INTO `sys_logininfor` VALUES (107, 'admin', '127.0.0.1', '内网IP', 'Chrome 8', 'Windows 10', '1', '验证码已失效', '2021-03-26 18:47:46');
INSERT INTO `sys_logininfor` VALUES (108, 'admin', '127.0.0.1', '内网IP', 'Chrome 8', 'Windows 10', '1', '验证码已失效', '2021-03-26 18:47:46');
INSERT INTO `sys_logininfor` VALUES (109, 'admin', '127.0.0.1', '内网IP', 'Chrome 8', 'Windows 10', '1', '验证码错误', '2021-03-26 18:48:04');
INSERT INTO `sys_logininfor` VALUES (110, 'admin', '127.0.0.1', '内网IP', 'Chrome 8', 'Windows 10', '0', '登录成功', '2021-03-26 18:48:17');
INSERT INTO `sys_logininfor` VALUES (111, 'admin', '127.0.0.1', '内网IP', 'Chrome 8', 'Windows 10', '0', '登录成功', '2021-03-31 17:28:07');
INSERT INTO `sys_logininfor` VALUES (112, 'admin', '127.0.0.1', '内网IP', 'Chrome 8', 'Windows 10', '0', '退出成功', '2021-03-31 17:35:17');
INSERT INTO `sys_logininfor` VALUES (113, 'admin', '127.0.0.1', '内网IP', 'Chrome 8', 'Windows 10', '1', '验证码错误', '2021-03-31 17:35:21');
INSERT INTO `sys_logininfor` VALUES (114, 'admin', '127.0.0.1', '内网IP', 'Chrome 8', 'Windows 10', '1', '验证码错误', '2021-03-31 17:35:25');
INSERT INTO `sys_logininfor` VALUES (115, 'admin', '127.0.0.1', '内网IP', 'Chrome 8', 'Windows 10', '0', '登录成功', '2021-03-31 17:35:33');
INSERT INTO `sys_logininfor` VALUES (116, 'admin', '127.0.0.1', '内网IP', 'Chrome 8', 'Windows 10', '0', '登录成功', '2021-03-31 17:58:36');
INSERT INTO `sys_logininfor` VALUES (117, 'admin', '127.0.0.1', '内网IP', 'Chrome 8', 'Windows 10', '1', '验证码已失效', '2021-03-31 17:59:30');
INSERT INTO `sys_logininfor` VALUES (118, 'admin', '127.0.0.1', '内网IP', 'Chrome 8', 'Windows 10', '0', '登录成功', '2021-03-31 17:59:42');
INSERT INTO `sys_logininfor` VALUES (119, 'admin', '127.0.0.1', '内网IP', 'Chrome 8', 'Windows 10', '1', '验证码错误', '2021-04-01 14:18:49');
INSERT INTO `sys_logininfor` VALUES (120, 'admin', '127.0.0.1', '内网IP', 'Chrome 8', 'Windows 10', '0', '登录成功', '2021-04-01 14:18:54');
INSERT INTO `sys_logininfor` VALUES (121, 'admin', '127.0.0.1', '内网IP', 'Chrome 8', 'Windows 10', '0', '登录成功', '2021-04-01 15:44:03');
INSERT INTO `sys_logininfor` VALUES (122, 'admin', '127.0.0.1', '内网IP', 'Chrome 8', 'Windows 10', '0', '退出成功', '2021-04-01 16:18:08');
INSERT INTO `sys_logininfor` VALUES (123, 'admin', '127.0.0.1', '内网IP', 'Chrome 8', 'Windows 10', '0', '登录成功', '2021-04-01 16:18:26');
INSERT INTO `sys_logininfor` VALUES (124, 'admin', '127.0.0.1', '内网IP', 'Chrome 8', 'Windows 10', '0', '登录成功', '2021-04-02 13:45:29');
INSERT INTO `sys_logininfor` VALUES (125, 'admin', '127.0.0.1', '内网IP', 'Chrome 8', 'Windows 10', '0', '登录成功', '2021-04-02 17:30:26');
...
) ENGINE = InnoDB AUTO_INCREMENT = 24 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '操作日志记录' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of sys_oper_log
-- ----------------------------
INSERT INTO `sys_oper_log` VALUES (1, '用户头像', 2, 'com.ruoyi.web.controller.system.SysProfileController.avatar()', 'POST', 1, 'admin', NULL, '/system/user/profile/avatar', '127.0.0.1', '内网IP', '', '{\"msg\":\"操作成功\",\"imgUrl\":\"/profile/avatar/2021/03/23/cabaf3c7-93a7-4ad2-a683-fde5242c47a8.jpeg\",\"code\":200}', 0, NULL, '2021-03-23 15:22:44');
INSERT INTO `sys_oper_log` VALUES (2, '字典类型', 1, 'com.ruoyi.web.controller.system.SysDictTypeController.add()', 'POST', 1, 'admin', NULL, '/system/dict/type', '127.0.0.1', '内网IP', '{\"createBy\":\"admin\",\"dictName\":\"用户操作类型\",\"remark\":\"用户操作类型\",\"params\":{},\"dictType\":\"operation_type\",\"status\":\"0\"}', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2021-03-26 18:51:39');
INSERT INTO `sys_oper_log` VALUES (3, '字典数据', 1, 'com.ruoyi.web.controller.system.SysDictDataController.add()', 'POST', 1, 'admin', NULL, '/system/dict/data', '127.0.0.1', '内网IP', '{\"dictValue\":\"1\",\"dictSort\":0,\"params\":{},\"dictType\":\"operation_type\",\"dictLabel\":\"点赞\",\"createBy\":\"admin\",\"default\":false,\"status\":\"0\"}', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2021-03-26 18:52:08');
INSERT INTO `sys_oper_log` VALUES (4, '字典数据', 1, 'com.ruoyi.web.controller.system.SysDictDataController.add()', 'POST', 1, 'admin', NULL, '/system/dict/data', '127.0.0.1', '内网IP', '{\"dictValue\":\"2\",\"dictSort\":0,\"params\":{},\"dictType\":\"operation_type\",\"dictLabel\":\"踩一踩\",\"createBy\":\"admin\",\"default\":false,\"status\":\"0\"}', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2021-03-26 18:52:21');
INSERT INTO `sys_oper_log` VALUES (5, '字典数据', 1, 'com.ruoyi.web.controller.system.SysDictDataController.add()', 'POST', 1, 'admin', NULL, '/system/dict/data', '127.0.0.1', '内网IP', '{\"dictValue\":\"3\",\"dictSort\":0,\"params\":{},\"dictType\":\"operation_type\",\"dictLabel\":\"转发\",\"createBy\":\"admin\",\"default\":false,\"status\":\"0\"}', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2021-03-26 18:52:30');
INSERT INTO `sys_oper_log` VALUES (6, '字典数据', 1, 'com.ruoyi.web.controller.system.SysDictDataController.add()', 'POST', 1, 'admin', NULL, '/system/dict/data', '127.0.0.1', '内网IP', '{\"dictValue\":\"4\",\"dictSort\":0,\"params\":{},\"dictType\":\"operation_type\",\"dictLabel\":\"收藏\",\"createBy\":\"admin\",\"default\":false,\"status\":\"0\"}', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2021-03-26 18:52:39');
INSERT INTO `sys_oper_log` VALUES (7, '字典数据', 1, 'com.ruoyi.web.controller.system.SysDictDataController.add()', 'POST', 1, 'admin', NULL, '/system/dict/data', '127.0.0.1', '内网IP', '{\"dictValue\":\"4\",\"dictSort\":0,\"params\":{},\"dictType\":\"operation_type\",\"dictLabel\":\"收藏\",\"createBy\":\"admin\",\"default\":false,\"status\":\"0\"}', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2021-03-26 18:52:40');
INSERT INTO `sys_oper_log` VALUES (8, '字典类型', 3, 'com.ruoyi.web.controller.system.SysDictDataController.remove()', 'DELETE', 1, 'admin', NULL, '/system/dict/data/33', '127.0.0.1', '内网IP', '{dictCodes=33}', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2021-03-26 18:52:44');
INSERT INTO `sys_oper_log` VALUES (9, '字典数据', 1, 'com.ruoyi.web.controller.system.SysDictDataController.add()', 'POST', 1, 'admin', NULL, '/system/dict/data', '127.0.0.1', '内网IP', '{\"dictValue\":\"5\",\"dictSort\":0,\"params\":{},\"dictType\":\"operation_type\",\"dictLabel\":\"评论\",\"createBy\":\"admin\",\"default\":false,\"status\":\"0\"}', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2021-03-26 18:52:54');
INSERT INTO `sys_oper_log` VALUES (10, '代码生成', 6, 'com.ruoyi.generator.controller.GenController.importTableSave()', 'POST', 1, 'admin', NULL, '/tool/gen/importTable', '127.0.0.1', '内网IP', 'busi_follows,busi_comment,busi_article,busi_image,busi_lable', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2021-03-31 17:32:51');
INSERT INTO `sys_oper_log` VALUES (11, '代码生成', 6, 'com.ruoyi.generator.controller.GenController.importTableSave()', 'POST', 1, 'admin', NULL, '/tool/gen/importTable', '127.0.0.1', '内网IP', 'busi_follows', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2021-03-31 17:44:01');
INSERT INTO `sys_oper_log` VALUES (12, '代码生成', 6, 'com.ruoyi.generator.controller.GenController.importTableSave()', 'POST', 1, 'admin', NULL, '/tool/gen/importTable', '127.0.0.1', '内网IP', 'sys_dept', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2021-03-31 17:49:39');
INSERT INTO `sys_oper_log` VALUES (13, '代码生成', 6, 'com.ruoyi.generator.controller.GenController.importTableSave()', 'POST', 1, 'admin', NULL, '/tool/gen/importTable', '127.0.0.1', '内网IP', 'busi_article', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2021-03-31 18:00:40');
INSERT INTO `sys_oper_log` VALUES (14, '代码生成', 6, 'com.ruoyi.generator.controller.GenController.importTableSave()', 'POST', 1, 'admin', NULL, '/tool/gen/importTable', '127.0.0.1', '内网IP', 'busi_article', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2021-03-31 18:10:18');
INSERT INTO `sys_oper_log` VALUES (15, '代码生成', 8, 'com.ruoyi.generator.controller.GenController.batchGenCode()', 'GET', 1, 'admin', NULL, '/tool/gen/batchGenCode', '127.0.0.1', '内网IP', '{}', 'null', 0, NULL, '2021-03-31 18:10:36');
INSERT INTO `sys_oper_log` VALUES (16, '代码生成', 3, 'com.ruoyi.generator.controller.GenController.remove()', 'DELETE', 1, 'admin', NULL, '/tool/gen/1', '127.0.0.1', '内网IP', '{tableIds=1}', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2021-04-01 15:44:20');
INSERT INTO `sys_oper_log` VALUES (17, '代码生成', 6, 'com.ruoyi.generator.controller.GenController.importTableSave()', 'POST', 1, 'admin', NULL, '/tool/gen/importTable', '127.0.0.1', '内网IP', 'busi_article', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2021-04-01 15:44:48');
INSERT INTO `sys_oper_log` VALUES (18, '代码生成', 8, 'com.ruoyi.generator.controller.GenController.batchGenCode()', 'GET', 1, 'admin', NULL, '/tool/gen/batchGenCode', '127.0.0.1', '内网IP', '{}', 'null', 0, NULL, '2021-04-01 15:45:02');
INSERT INTO `sys_oper_log` VALUES (19, '代码生成', 3, 'com.ruoyi.generator.controller.GenController.remove()', 'DELETE', 1, 'admin', NULL, '/tool/gen/2', '127.0.0.1', '内网IP', '{tableIds=2}', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2021-04-01 15:52:16');
INSERT INTO `sys_oper_log` VALUES (20, '代码生成', 6, 'com.ruoyi.generator.controller.GenController.importTableSave()', 'POST', 1, 'admin', NULL, '/tool/gen/importTable', '127.0.0.1', '内网IP', 'busi_article', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2021-04-01 15:52:23');
INSERT INTO `sys_oper_log` VALUES (21, '代码生成', 8, 'com.ruoyi.generator.controller.GenController.batchGenCode()', 'GET', 1, 'admin', NULL, '/tool/gen/batchGenCode', '127.0.0.1', '内网IP', '{}', 'null', 0, NULL, '2021-04-01 15:52:25');
INSERT INTO `sys_oper_log` VALUES (22, '代码生成', 3, 'com.ruoyi.generator.controller.GenController.remove()', 'DELETE', 1, 'admin', NULL, '/tool/gen/3', '127.0.0.1', '内网IP', '{tableIds=3}', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2021-04-01 16:16:39');
INSERT INTO `sys_oper_log` VALUES (23, '代码生成', 6, 'com.ruoyi.generator.controller.GenController.importTableSave()', 'POST', 1, 'admin', NULL, '/tool/gen/importTable', '127.0.0.1', '内网IP', 'busi_article', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2021-04-01 16:16:43');
...
-- Records of sys_user
-- ----------------------------
INSERT INTO `sys_user` VALUES (1, 103, 'admin', '若依', '00', 'ry@163.com', '15888888888', '1', '/profile/avatar/2021/03/23/cabaf3c7-93a7-4ad2-a683-fde5242c47a8.jpeg', '$2a$10$7JB720yubVSZvUI0rEqK/.VqGOZTH.ulu33dHOiBE8ByOhJIrdAu2', '0', '0', '127.0.0.1', '2018-03-16 11:33:00', 'admin', '2018-03-16 11:33:00', 'ry', '2018-03-16 11:33:00', '管理员');
