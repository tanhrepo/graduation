        ...
        <div class="fe-container-left ">
          ...
          <div class="fe-shadow article-detail">
            ...
            <div class="detail-title">
              <div class="fe-flex">
                <img
                  @click="jumpDetail('userPage', createUser.userId)"
                  :src="'http://localhost:8080' + createUser.avatar"
                  alt=""
                />
                <div class="detail-text flex-column-between">
                  <!--          昵称-->
                  <span @click="jumpDetail('userPage', createUser.userId)" class="fe-url">
                    {{ createUser.nickName || '张三' }}</span
                  >
                  <!--          信息-->
                  <span>
              ...
              <p>
                <el-button
                  type="primary"
                  v-if="!followView"
                  @click="follow(createUser.userId)"
                  plain
                  size="mini"
                  >关注
                </el-button>
                <el-button type="primary" v-else disabled plain size="mini"
                  >已关注
                </el-button>
              </p>
            </div>
            ...
            <div class="fe-flex-between detail-control">
              <span
                ><i class="iconfont icon-share" @click="share(detail.articleId)" /><span
                  >{{ detail.articleTransmitCount }}</span
                ></span
              >
              <span
                ><i class="iconfont icon-star" @click="collect(detail.articleId)" /><span
                  >{{ detail.articleCollectCount }}</span
                ></span
              >
              <span
                ><i class="iconfont icon-message" @click="commentDialog" /><span>{{
                  detail.articleCommentCount
                }}</span></span
              >
              <span
                ><i
                ...
                <i
                  @click="trampleArticle(detail.articleId, createUser.userId)"
                  class="iconfont icon-step"
              /></span>
            </div>

            <!--            分享-->
            <el-dialog title="分享" :visible.sync="searchView" width="30%">
  ...
  data() {
    return {
      ...
      detail: {
        ...
        articleContent:
          '一只公鸡，由于不愿参加一场斗鸡比赛，用身上绑着的刀，刺中其主人，最终导致对方因失血过多死亡。\n' +
          '\n' +
        ...
        imgs: [
          require('@/assets/images/item/item_01.png'),
          require('@/assets/images/item/item_02.png'),
          require('@/assets/images/item/item_03.png'),
          require('@/assets/images/item/item_04.png'),
          require('@/assets/images/item/item_05.png'),
          require('@/assets/images/item/item_01.png'),
          require('@/assets/images/item/item_02.png'),
          require('@/assets/images/item/item_03.png'),
          require('@/assets/images/item/item_04.png'),
      ...
      comment: [
        {
          ...
          content:
            '奥i毒发你打开就发你肯定就爱上了\n案件那就拉的看法呢\ni拿到结果你就骄傲的发你觉得爱哭的房间\n酷酷酷',
          imgs: [
            'http://localhost:8080/profile/upload/2021/04/20/90ad9aa0-5d83-43ad-8e24-81b52719b5d6.png',
            'http://localhost:8080/profile/upload/2021/04/20/a75f8fe1-1b29-45f5-923a-932b7fc59d98.png'
          ],
          parentId: null,
          answerUser: 1,
          praiseCount: 646,
        ...
        },
        {
          ...
          imgs: [
            'http://localhost:8080/profile/upload/2021/04/20/fb56fba8-b143-433d-8d3f-2d0d0ad671ee.png'
          ],
          parentId: null,
          answerUser: 1,
          praiseCount: 646,
        ...
        },
        {
          ...
          createUser: {
            avatar:
              '/profile/avatar/2021/04/19/6988e1c5-ba19-4de5-9092-700db4a7bee6.jpeg',
            nickName: '李四',
            userName: 'admin',
            userId: 1
          },
        ...
        },
        {
          ...
          content:
            '奥i毒发你打开就发你肯定就爱上了\n案件那就拉的看法呢\ni拿到结果你就骄傲的发你觉得爱哭的房间\n酷酷酷',
          imgs: [
            'http://localhost:8080/profile/upload/2021/04/20/05513d56-e630-49b3-af91-bcb7a34f610c.png',
            'http://localhost:8080/profile/upload/2021/04/19/a774eff0-7a97-45ee-8863-38a96fc4cec1.jpg'
          ],
          parentId: 1,
          answerUser: null,
        ...
        },
        {
          ...
          content:
            '奥i毒发你打开就发你肯定就爱上了\n案件那就拉的看法呢\ni拿到结果你就骄傲的发你觉得爱哭的房间\n酷酷酷',
          imgs: [
            'http://localhost:8080/profile/upload/2021/04/20/7a86a1ef-dfa9-4997-a7b5-27c8820bb7e7.png',
            'http://localhost:8080/profile/upload/2021/04/19/a774eff0-7a97-45ee-8863-38a96fc4cec1.jpg'
          ],
          parentId: 4,
          answerUser: null,
        ...
        },
        {
          ...
          content:
            '奥i毒发你打开就发你肯定就爱上了\n案件那就拉的看法呢\ni拿到结果你就骄傲的发你觉得爱哭的房间\n酷酷酷',
          imgs: [
            'http://localhost:8080/profile/upload/2021/04/20/fe95a95d-c127-464b-b7de-d1c91a6b2ef2.png',
  ...
  methods: {
    ...
    getData() {
      return new Promise((resolve, reject) => {
        getArticleItem(this.$route.query.id)
          .then(res => {
